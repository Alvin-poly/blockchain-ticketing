# Blockchain Ticketing (Enhanced Student Version)

This project is a decentralized event and ticketing system built on the Ethereum blockchain.  
Originally created for ConsenSys Academy 2018, this enhanced version includes additional
functionality and improvements developed as part of the CN6035 Mobile & Distributed Systems module.

Users can:
- Create events with a name, ticket price, and total supply.
- Purchase ERC‑721 non‑fungible tickets.
- Prove ticket ownership using a one‑time validation code.
- Redeem tickets at the event.

---

## 🔧 Back-End Enhancements (Smart Contracts)

As part of the coursework, the following improvements were added:

### ✔ `getEventDetails()` Function
A new view function was added to `Event.sol` to expose structured event metadata to the front-end:
...
This improves data retrieval and supports richer UI components.
